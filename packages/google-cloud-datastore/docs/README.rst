...
`Cloud Datastore`_: is a fully managed, schemaless database for
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-datastore.svg
   :target: https://pypi.org/project/google-cloud-datastore/
.. _Cloud Datastore: 
.. _Client Library Documentation: https://cloud.google.com/python/docs/reference/google-cloud-datastore/latest/summary_overview
...
.. _Cloud Datastore Product documentation:  
