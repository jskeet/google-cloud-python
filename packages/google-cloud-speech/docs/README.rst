...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-speech.svg
   :target: https://pypi.org/project/google-cloud-speech/
.. _Cloud Speech-to-Text: https://cloud.google.com/speech-to-text/docs/
...
.. _Enable the Cloud Speech-to-Text.:  https://cloud.google.com/speech-to-text/docs/
...
.. _Cloud Speech-to-Text Product documentation:  https://cloud.google.com/speech-to-text/docs/
