Python Client for IAM Audit Logging
===================================
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-iam-logging.svg
   :target: https://pypi.org/project/google-cloud-iam-logging/
.. _IAM Audit Logging: https://cloud.google.com/iam/docs/audit-logging
...
3. `Enable the IAM Audit Logging.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the IAM Audit Logging.:  https://cloud.google.com/iam/docs/audit-logging
...
-  Read the `Client Library Documentation`_ for IAM Audit Logging
   to see other available methods on the client.
-  Read the `IAM Audit Logging Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _IAM Audit Logging Product documentation:  https://cloud.google.com/iam/docs/audit-logging
