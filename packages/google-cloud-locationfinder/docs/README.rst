Python Client for Cloud Location Finder
=======================================
...
.. |versions| image:: https://img.shields.io/pypi/pyversions/google-cloud-locationfinder.svg
   :target: https://pypi.org/project/google-cloud-locationfinder/
.. _Cloud Location Finder: https://issuetracker.google.com/issues/new?component=1569265&template=1988535
...
3. `Enable the Cloud Location Finder.`_
4. `Set up Authentication.`_

.. _Select or create a Cloud Platform project.: https://console.cloud.google.com/project
.. _Enable billing for your project.: https://cloud.google.com/billing/docs/how-to/modify-project#enable_billing_for_a_project
.. _Enable the Cloud Location Finder.:  https://issuetracker.google.com/issues/new?component=1569265&template=1988535
...
-  Read the `Client Library Documentation`_ for Cloud Location Finder
   to see other available methods on the client.
-  Read the `Cloud Location Finder Product documentation`_ to learn
   more about the product and see How-to Guides.
-  View this `README`_ to see the full list of Cloud
   APIs that we cover.

.. _Cloud Location Finder Product documentation:  https://issuetracker.google.com/issues/new?component=1569265&template=1988535
